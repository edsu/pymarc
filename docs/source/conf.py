...
with open(os.path.join(os.path.dirname(__file__), '../../setup.py')) as setup_file:
    version_line = setup_file.readline()
...
latex_documents = [
    (master_doc, 'pymarc.tex', 'pymarc Documentation',
     'Ed Summers', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymarc', 'pymarc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pymarc', 'pymarc Documentation',
     author, 'pymarc', 'One line description of project.',
     'Miscellaneous'),
]
